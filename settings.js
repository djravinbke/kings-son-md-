...
global.owner = process.env.OWNER_NUMBER  || '' ;  // ADD YOUR NUMBER WITHOUT 254708430362
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'youre session id' ,VAJIRA-MD=eRtTWYoK#jMKJQW0vqEhcMF3rcx_zaZD_pe7_Gh5UDJEudn3ZgKo
